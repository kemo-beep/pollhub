...
>(({ defaultOpen = true, open: openProp, onOpenChange: setOpenProp, className, style, children, ...props }, ref) => {
    ...
    const contextValue = React.useMemo<SidebarContext>(
        () => ({
            ...
            isMobile,
            openMobile,
            setOpenMobile: toggleMobileSidebar,
            toggleSidebar,
        }),
        [state, open, setOpen, isMobile, openMobile, toggleMobileSidebar, toggleSidebar]
    )
        ...
        return (
            <button
                ...
                className={cn(
                    ...
                    "group-data-[collapsible=offcanvas]:flex group-data-[collapsible=icon]:flex",
                    className
                )}
                {...props}
            />
...
const SidebarSeparator = React.forwardRef<
    ...
    React.ComponentProps<typeof import("@radix-ui/react-separator").Root>
>(({ className, ...props }, ref) => {
    ...
    ({ className, ...props }, ref) => {
        return (
            <div
                ...
                className={cn("flex min-h-0 flex-1 flex-col gap-2 overflow-auto group-data-[collapsible=icon]:overflow-hidden px-3 py-2", className)}
                {...props}
            />
        )
    }
    ...
    ({ className, ...props }, ref) => {
        return (
            <button
                ...
                className={cn(
                    "absolute right-2 top-2 flex aspect-square w-5 items-center justify-center rounded-md p-0 text-sidebar-foreground outline-none ring-sidebar-ring transition-transform hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
...
>(({ className, asChild = false, showOnHover = false, ...props }, ref) => {
    ...
    return (
        <Comp
            ...
            className={cn(
                "absolute right-2 top-2.5 flex aspect-square w-5 items-center justify-center rounded-md p-0 text-sidebar-foreground outline-none ring-sidebar-ring transition-transform hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 peer-hover/menu-button:text-sidebar-accent-foreground [&>svg]:size-4 [&>svg]:shrink-0",
